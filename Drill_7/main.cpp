...
int main()
{
	...
	cout << "Copied increased array into second vector: ";
	...
	if (elem1 != v.end()) // Ha nincs benne az adott konténerben
		...
		cout << element1 << " is not in the increased vector." << endl;

	auto elem2 = find(l.begin(),l.end(),element2);
	if (elem2 != l.end())
		cout << element2 << " is at " << distance(l.begin(),elem2) << " index." << endl;
	else
		cout << element2 << " is not in the increased list." << endl;
